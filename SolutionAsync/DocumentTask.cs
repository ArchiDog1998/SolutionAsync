...
//            List<IGH_ActiveObject> objList = new (Document.ObjectCount);
//            List<Action> setIndexList = new (Document.ObjectCount);
...
//            //Get Graph
//            var getLevels = Task.Run(() =>
//                Calculatelevel.CreateLevels(objList, setIndexList, Data.UseSolutionOrderedLevelAsync, ignoreList, mode));
